...
public class BPDiagramControllerRectangleSelect extends BPDiagramControllerBase
{
	...
	protected void startRect(int x, int y)
	{
		...
		BPDiagramComponent comp = m_compref.get();
		if (comp != null)
			comp.setComponentOverlay(m_overlay);
	}
	...
	protected void endRect(int x, int y)
	{
		...
		if (comp != null)
		{
			...
			if (d != null)
			{
				...
				comp.getRawSelection().setKeys(selkeys);
			}
			clearState();
		}
	}
