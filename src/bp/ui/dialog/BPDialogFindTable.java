...
public class BPDialogFindTable extends BPDialogCommon
{
	/**
	 * 
	 */
	...
	public BPDialogFindTable(BPTable<?> table)
	{
		super((Window) table.getFocusCycleRootAncestor());
		m_table=table;
	}
	...
	protected void onFind(ActionEvent e)
	{
		...
		if (src.length() == 0)
			return;
		m_table.find(src, !m_chkbackward.isSelected(), m_chkword.isSelected(), m_chkcase.isSelected(), false);
	}
